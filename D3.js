...
//cambio il valore mass dell'elemento 8
...
while(z < starWarsCharacters.length){
  crewMass2 += Number(starWarsCharacters[z].mass)
  z++
}

console.log('crewMass', crewMass2)
...
switch(true){
  ...
  case (crewMass2 === 500) :
    console.log('Ship is half loaded')
    break
  case (crewMass2 > 700 && crewMass2 <= 900) :
    console.log('Warning: Load is over 700')
    break
  case (crewMass2 > 900 && crewMass2 <= 1000) :
    console.log('Critical Load: Over 900')
    break
  default :
    console.log('DANGER! OVERLOAD ALERT: escape from ship now!')
